<?php
/**
 * Native article listing — Timber entry (Page → Light article template).
 *
...
if ( ! class_exists( '\Timber\Timber' )
	|| ! class_exists( 'Hello_Elementor_Child_Light_Article_Template' )
	|| ! class_exists( 'Hello_Elementor_Child_Light_Product_Template' )
) {
	status_header( 500 );
	wp_die( esc_html__( 'Timber یا Article template در دسترس نیست.', 'hello-elementor-child' ) );
}
...
$context['body_class']               = implode( ' ', get_body_class( 'lk-light-product lk-light-article lk-shop-cards-archive lz-chrome' ) );
...
$context['article'] = Hello_Elementor_Child_Light_Article_Template::get_page_content();

echo '<!-- LK-LIGHT-ARTICLE-TEMPLATE-ACTIVE -->' . "\n";
